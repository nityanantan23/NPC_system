const en = {
  ...
  entities: {
    patients: {
        ...
        label: 'Patients',
        menu: 'Patients',
        exporterFileName: 'patients_export',
        list: {
          menu: 'Patients',
          title: 'Patients',
        },
        create: {
          success: 'Patients successfully saved',
        },
        update: {
          success: 'Patients successfully saved',
        },
        destroy: {
          success: 'Patients successfully deleted',
        },
        destroyAll: {
          success: 'Patients(s) successfully deleted',
        },
        edit: {
          title: 'Edit Patients',
        },
    ...
    treatment: {
        ...
        label: 'Treatments',
        menu: 'Treatments',
        exporterFileName: 'treatment_export',
        list: {
          menu: 'Treatments',
          title: 'Treatments',
        },
        create: {
          success: 'Treatment successfully saved',
        },
        update: {
          success: 'Treatment successfully saved',
        },
        destroy: {
          success: 'Treatment successfully deleted',
        },
        destroyAll: {
          success: 'Treatment(s) successfully deleted',
        },
        edit: {
    ...
    vitalSign: {
        ...
        label: 'VitalSigns',
        menu: 'VitalSigns',
        exporterFileName: 'vitalSign_export',
        list: {
          menu: 'VitalSigns',
          title: 'VitalSigns',
        },
        create: {
          success: 'VitalSign successfully saved',
        },
        update: {
          success: 'VitalSign successfully saved',
        },
        destroy: {
          success: 'VitalSign successfully deleted',
        },
        destroyAll: {
          success: 'VitalSign(s) successfully deleted',
        },
        edit: {
          title: 'Edit VitalSign',
        },
        fields: {
          id: 'Id',
          'patientID': 'PatientID',
        ...
        view: {
          title: 'View VitalSign',
        },
        importer: {
          title: 'Import VitalSigns',
