const es = {
  ...
  entities: {
    patients: {
        ...
        label: 'Patients',
        menu: 'Patients',
        exporterFileName: 'exportacion_patients',
        list: {
          menu: 'Patients',
          title: 'Patients',
        },
        create: {
          success: 'Patients guardado con éxito',
        },
        update: {
          success: 'Patients guardado con éxito',
        },
        destroy: {
          success: 'Patients eliminado con éxito',
        },
        destroyAll: {
          success: 'Patients(s) eliminado con éxito',
        },
        edit: {
        ...
        importer: {
          ...
          fileName: 'patients_import_template',
          hint:
    ...
    treatment: {
        ...
        label: 'Treatments',
        menu: 'Treatments',
        exporterFileName: 'exportacion_treatment',
        list: {
          menu: 'Treatments',
          title: 'Treatments',
        },
        create: {
          success: 'Treatment guardado con éxito',
        },
        update: {
          success: 'Treatment guardado con éxito',
        },
        destroy: {
          success: 'Treatment eliminado con éxito',
        },
        destroyAll: {
          success: 'Treatment(s) eliminado con éxito',
        },
        edit: {
        ...
        importer: {
          ...
          fileName: 'treatment_import_template',
          hint:
            'Las columnas Archivos/Imágenes deben ser las URL de los archivos separados por espacio.',
        },
      },
    ...
    vitalSign: {
        ...
        label: 'VitalSigns',
        menu: 'VitalSigns',
        exporterFileName: 'exportacion_vitalSign',
        list: {
          menu: 'VitalSigns',
          title: 'VitalSigns',
        },
        create: {
          success: 'VitalSign guardado con éxito',
        },
        update: {
          success: 'VitalSign guardado con éxito',
        },
        destroy: {
          success: 'VitalSign eliminado con éxito',
        },
        destroyAll: {
          success: 'VitalSign(s) eliminado con éxito',
        },
        edit: {
        ...
        importer: {
          ...
          fileName: 'vitalSign_import_template',
          hint:
            'Las columnas Archivos/Imágenes deben ser las URL de los archivos separados por espacio.',
        },
      },
