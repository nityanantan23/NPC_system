...
import VitalSignFormModal from 'src/view/vitalSign/form/VitalSignFormModal';
...
const VitalSignAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return VitalSignService.listAutocomplete(value, limit);
  };
...
export default VitalSignAutocompleteFormItem;
