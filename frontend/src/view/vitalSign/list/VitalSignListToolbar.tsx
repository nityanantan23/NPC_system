...
const VitalSignToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    vitalSignSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    vitalSignSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=vitalSign">
...
export default VitalSignToolbar;
