...
const TreatmentToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    treatmentSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    treatmentSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=treatment">
